...
if(cook!=null){
	for(Cookie c:cook){
		if("username".endsWith(c.getName())){		
			username=c.getValue();
		}else if("userpwd".endsWith(c.getName())){
			password=c.getValue();
		}
	}
}
...
<!-- 页面主体 -->
 <div id="banner">
   ...
   <div id="left">
   <!--页面左部表单设置-->
   <form id="LoginForm" action="Lservlet?xra=a" method="post" onsubmit="return checkForm()">
     <table width="565" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td class="if"><input name="userId" type="text" class="la" id="userId" style="color: #DCDCDC;" placeholder="请输入正确的邮箱或手机号" value="<%=username %>" /></td>
         <td></td>
       </tr>
       <tr>
         <td class="le"></td>
         <td class="ld">密码</td>
         <td class="if"><input name="passWord" type="password" class="la" id="passWord" value="<%=password %>"/></td>
         <td></td>
       </tr>
       <tr>
         <td class="le"></td>
       ...
       <tr>
         ...
         <td><label id="upint" style="color: red;">${requestScope.pint}</label></td>
       </tr>
     </table>
     </form>
     <!--页面左部表单结束-->
   ...
   <div id="right">
            ...
            <div class="ds"><a href="#"><img src="images/anniu.gif" alt="立即注册" width="155" height="48" border="0" title="在这注册" /></a>
            </div>
   	</div>
  </div>
   <!--页面右部文字及按钮设置结束-->
